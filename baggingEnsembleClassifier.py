...
dtree=BaggingClassifier(decisiontreeclassifier, max_samples=50)
dtree.fit(X_train,Y_train)
scores1=dtree.predict(X_test)
print(scores1)
 
#performance evaluation code of scores1(dtree)
...
knn=BaggingClassifier(knnclassifier, max_samples=50)
knn.fit(X_train,Y_train)
scores2=(knn.predict(X_test))
print(scores2)
 
#performance evaluation code of scores2(knn)
from sklearn.metrics import confusion_matrix
...
nb=BaggingClassifier(nbclassifier, max_samples=50)
